    ...
    return (
        <Form className="form">
            <FormGroup>
                ...
                <Input type="text" name="nickname" placeholder="Your plant nickname"/>
            </FormGroup>
            <FormGroup>
                <Label for="species">Species</Label>
                <Input type="text" name="species" placeholder="Plant's species"/>
            </FormGroup>
            <FormGroup>
                <Label for="waterschedule">Watering Schedule</Label>
                <Input type="select" name="waterschedule" placeholder="Your plant nickname">
